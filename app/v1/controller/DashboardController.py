...
class DashboardController:
    ...
    def get_grades():
        ...
        try:
            ...
            student_id = user.student_id if user.role == 'parent' else request.args.get('student_id')
            if not student_id:
            ...
            response['subjects'] = list(subjects.values())
        ...
        try:
            ...
            for record in attendance_records:
                ...
                if year and record.attendance_date.year != int(year):
                    continue
                response['attendance'].append({'date': record.attendance_date, 'status': record.status})
        ...
        try:
            ...
            for record in behavior_records:
                ...
                if end_date and record.record_date > datetime.strptime(end_date, '%Y-%m-%d').date():
                    continue
                response['behavior_records'].append({
